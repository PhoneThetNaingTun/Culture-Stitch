...
export const OrderDeliveringDialog = ({ id }: Prop) => {
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="bg-green-500 text-white">Edit to Delivering</Button>
      </DialogTrigger>
      <DialogContent className="max-w-xl">
        <DialogTitle>This will change the status to delivering!</DialogTitle>
