    ...
    <div className="bg-black pt-5 mt-10 relative ">
      ...
      <div className="lg:px-28 px-6 mt-10 lg:mt-28  flex flex-col gap-5 justify-between lg:flex-row ">
        ...
        <div className="flex-1 z-10">
          ...
          <Input className="bg-transparent border-b-1 border-white border-x-0 border-t-0 focus-visible:ring-0 text-white rounded-none" />
          <div className="mt-3 flex justify-end">
            <Button className="bg-white text-black hover:bg-gray-300 transition-transform duration-700 hover:text-black">
              Submit
            </Button>
          </div>
        </div>
